...
browser: ["QUEEN-PRIYA-V1", "Safari", "3.0"], 
...
//Auto Update
require('./lib/serialize.jrequire('./lib/message.js')
nocache('./lib/serialize.js', module => console.log(`[ QUEEN-PRIYA-V1 ]  ${time} ${module} has been updated!`))
nocache('./lib/message.js', module => console.log(`[ QUEEN-PRIYA-V1 ]  ${time} ${module} has been updated!`))
